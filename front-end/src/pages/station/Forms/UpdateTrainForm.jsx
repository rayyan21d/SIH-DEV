    ...
    <Box sx={{ flex: 1, width: '100%' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card>
          {/* Card1 */}
          <Box sx={{ mb: 1 }}>
            <Typography level="title-md">Form to update train details</Typography>
          </Box>
          <Divider />
          <Stack
            direction="row"
          ...
          >
            ...
            <Stack spacing={2} sx={{ flexGrow: 1 }}>
              <Stack spacing={1}>
                ...
                <FormLabel>Station Currently at</FormLabel>
                <FormControl required
                  sx={{ display: { sm: 'flex-column', md: 'flex-row' }, gap: 2 }}
                >
                  <Input size="sm" placeholder="Station Currently at" name="stationCurrentlyAt" />
                </FormControl>
                ...
                <FormControl required
                  sx={{ display: { sm: 'flex-column', md: 'flex-row' }, gap: 2 }}
                >
                  <Input size="sm" placeholder="Capacity" name="capacity" />
                </FormControl>
